...
def my_max(num_lst):
    # TODO: не правильно сделано. Прочитай внимательно Примечание
    for num in num_lst:
...
# в списке и возвращает его.
def my_min(num_lst):
    # TODO: не правильно сделано. Сделай сначала my_max а потом тут перепиши. my_sum сделан правильно!

    for min_num in num_lst:
        min_value = min(num_lst)
        return min_value
...
def my_sum(num_lst):
    ...
    for s in num_lst:
        total = total + s
        #  TODO: Тут ошибка - у тебя только первое число в списке обработается и потом возврат из функции -
        #   return не в правильной позиции
        return total
...
#  TODO: текущая реализация возвращает 10
print(sum_res)
...
#  TODO: текущая реализация возвращает 13
print(sum_res)
...
index_letter_res = index_in_list(['a', 'b', 'c', 'd'], 'c')
print(index_letter_res)

index_letter_res = index_in_list(['a', 'b', 'c', 'd'], 'y')
print(index_letter_res)